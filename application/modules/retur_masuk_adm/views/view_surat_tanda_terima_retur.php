  ...
  <div class="container">
    <?php foreach ($hasil_header as $val ) : ?>
      ...
      <table class="tbl-header">
        <tr>
          <td align="left">
              <p style="text-align: left;" class="head-left">ID Retur Masuk : <?php echo $val->id_retur_masuk; ?></p>
              <p style="text-align: left;" class="head-left">ID Retur : <?php echo $val->id_retur_keluar; ?></p>
          </td>
          <td align="right">
              <p style="text-align: right; font-size: 14px" class="head-left"><strong>Surabaya, <?php echo $val->tgl_retur_masuk; ?></strong></p>
          </td>
        </tr>
        <tr> 
          <td align="left" class="head-left" colspan="2">
            <p style="text-align: left; font-size: 12px" class="head-left">Diterima Retur Dari : <strong><?php echo $val->nama_supplier; ?></strong></p>
        ...
        <tr class="inner-head-left"> 
          <td align="left" class="inner-head-left" colspan="2">
            <p style="text-align: left; font-size: 12px" class="inner-head-left">Telah diterima retur produk dengan kondisi baik dari <strong><?php echo $val->nama_supplier; ?></strong>, berikut adalah produk retur yang telah diterima :</p>
          </td>
        </tr>    
      </table>
    <?php endforeach ?>
    ...
    <table class="tbl-content-footer">
        <tr class="content-footer-left"> 
          <td align="left" class="content-footer-left" colspan="5">
            <p style="text-align: left; font-size: 12px" class="content-footer-left">Dimohon agar disertakan surat tanda terima retur ini pada saat melakukan <strong>penagihan</strong> pada kasir kami, Terima kasih.</p>
          </td>
        </tr>  
      </table>
